...
}// https://blog.csdn.net/m00123456789/article/details/60142613
</script>

<style lang="css">
.m-map{ min-width: 500px; min-height: 680px; position: relative; }
...
.m-map .search button{ line-height: 26px; background: #0FCBB8;color:#fff; border: 1px solid #ccc; width: 50px; text-align: center; }
